...
<?php require "global.php"; require "connect.php"; ?>
...
<div id="wrapper-navbar" style="opacity: 1; height: 60px;">
		<div class="navbar object">
            ...
            <div class="oldies object" style="color:black">Latest Shows Added</div>
                <div id="fleche-nav-3"></div>
    		</div>
            </div>
        ...
        ?>
						<figure class="white">
							<a>
								...
								<dl>
									<dt><?php echo $gl['name']; ?></dt>
									<dd> <?php echo $gl['description']; ?> </dd>
							</dl>
							</a>
							<a href="shows.php?category=<?php echo $gl['category']; ?>&series=<?php echo $gl['name']; ?>">
                            <div id="wrapper-part-info">
                            	<div class="part-info-image"><img src="<?php echo $letters[1]; ?>" alt="" width="28" height="28"></div>
                            	<div id="part-info"><?php echo $gl['name']; ?></div>
							</div>
							</a>
                        </figure>
<?php
...
/* DISABLE HOVER EFFECT WHILE YOU SCROLL FOR A SMOOTH NAVIGATION */
